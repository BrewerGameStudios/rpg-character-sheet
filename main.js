            ...
            submenu: [
                {
                    ...
                    click: () => {
                        ...
                        dialog.showMessageBox(mainWindow, {
                            ...
                            message: 'RPG Character Sheet v2.3.0', // UPDATE VERSION NUMBER WHEN UPDATING
                ...
                },
                {
                    ...
                    click: () => {
                        ...
                        const subject = encodeURIComponent('Bug Report: RPG Character Sheet v2.3.0'); // **************************UPDATE VERSION NUMBER WHEN UPDATING ***************************************
                        const body = encodeURIComponent(
                            ...
                            'Version: 2.3.0'  // **************************UPDATE VERSION NUMBER WHEN UPDATING ***************************************
                        );
